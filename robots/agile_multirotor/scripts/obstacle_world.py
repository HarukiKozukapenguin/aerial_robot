...
class ObstacleWorld:
    def __init__(self):
        ...
        self.spawnWall("wall_body", 0.5, np.array([3.2,0.4,1]) + np.array([shift_x,shift_y,0]), 0.01, 0.6, 2)
        self.spawnWall("wall_pole", 0.5, np.array([3.2,-0.90,1]) + np.array([shift_x,shift_y,0]), 0.01, 0.05, 2)
        self.spawnWall("stepladder", 0.5, np.array([0.9,-0.9,0.92]) + np.array([shift_x,shift_y,0]), 0.842, 0.92, 1.84)
        self.spawnWall("chair", 0.5, np.array([2.2,0.9,0.55]) + np.array([shift_x,shift_y,0]), 0.20, 0.45, 1.10)
